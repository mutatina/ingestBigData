...
SELECT *
from retail_stg_test.order_details_test2 AS stg_tbl
where stg_tbl.trans_date BETWEEN '2017-01-27' AND '2017-01-27';

Parameterized:Needs 6 parameters( finaldb name, stage database name, table name(same for both) partition column, min load date , max load date) */
